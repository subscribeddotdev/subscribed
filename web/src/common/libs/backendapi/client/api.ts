...
export interface CreateEventTypePayload {
   ...
   *
   * @type {string}
   * @memberof CreateEventTypePayload
   */
  id: string;
}
/**
...
export type EnvironmentTypeEnum =
  (typeof EnvironmentTypeEnum)[keyof typeof EnvironmentTypeEnum];
 ...
 *
 * @export
 * @interface GetEventTypeByIdPayload
 */
export interface GetEventTypeByIdPayload {
  /**
   *
   * @type {EventType}
   * @memberof GetEventTypeByIdPayload
   */
  data: EventType;
}
/**
...
export const ApiKeysApiAxiosParamCreator = function (
  ...
  return {
    ...
    destroyApiKey: async (
      ...
      const localVarPath = `/api-keys/{apiKeyId}`.replace(
        `{${"apiKeyId"}}`,
  ...
  return {
    ...
    async createApiKey(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<CreateApiKeyPayload>
    > {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.destroyApiKey(
        apiKeyId,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ApiKeysApi.destroyApiKey"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getAllApiKeys(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<GetAllApiKeysPayload>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ApiKeysApi.getAllApiKeys"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const ApiKeysApiFactory = function (
  ...
  return {
    ...
    destroyApiKey(
      ...
      return localVarFp
        .destroyApiKey(apiKeyId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getAllApiKeys(
      ...
      return localVarFp
        .getAllApiKeys(environmentId, options)
        .then((request) => request(axios, basePath));
    },
  };
};
  ...
  return {
    ...
    async createApplication(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<CreateApplicationPayload>
    > {
    ...
    async getApplicationById(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<GetApplicationByIdPayload>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getApplicationById(
          applicationID,
          options
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ApplicationsApi.getApplicationById"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getApplications(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<GetApplicationsPayload>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["ApplicationsApi.getApplications"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const ApplicationsApiFactory = function (
  ...
  return {
    ...
    getApplications(
      ...
      return localVarFp
        .getApplications(environmentID, limit, page, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export const AuthApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async signIn(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<SignInPayload>
    > {
 ...
 * @export
 */
export const EndpointsApiAxiosParamCreator = function (
  configuration?: Configuration
) {
  return {
    /**
    ...
    addEndpoint: async (
      ...
      const localVarPath = `/applications/{applicationID}/endpoints`.replace(
        `{${"applicationID"}}`,
        encodeURIComponent(String(applicationID))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const EndpointsApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    EndpointsApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @summary Add an endpoint to an application
    ...
    async addEndpoint(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.addEndpoint(
        applicationID,
        addEndpointRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["EndpointsApi.addEndpoint"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const EndpointsApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
    ...
    addEndpoint(
      ...
      return localVarFp
        .addEndpoint(applicationID, addEndpointRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class EndpointsApi extends BaseAPI {
  ...
  public addEndpoint(
    ...
    return EndpointsApiFp(this.configuration)
      .addEndpoint(applicationID, addEndpointRequest, options)
      .then((request) => request(this.axios, this.basePath));
  }
}
  ...
  return {
    ...
    async getEnvironments(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<GetAllEnvironmentsPayload>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getEnvironments(
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["EnvironmentsApi.getEnvironments"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const EventTypesApiAxiosParamCreator = function (
  configuration?: Configuration
) {
  return {
    /**
    ...
    getEventTypeById: async (
      ...
      assertParamExists("getEventTypeById", "eventTypeID", eventTypeID);
      const localVarPath = `/event-types/{eventTypeID}`.replace(
        `{${"eventTypeID"}}`,
...
export const EventTypesApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    EventTypesApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @summary Creates a new event type
    ...
    async createEventType(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<CreateEventTypePayload>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createEventType(
        createEventTypeRequest,
        options
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["EventTypesApi.createEventType"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getEventTypeById(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<GetEventTypeByIdPayload>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getEventTypeById(eventTypeID, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["EventTypesApi.getEventTypeById"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getEventTypes(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<GetEventTypesPayload>
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["EventTypesApi.getEventTypes"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const EventTypesApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  ...
  return {
    ...
    createEventType(
      ...
      return localVarFp
        .createEventType(createEventTypeRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getEventTypeById(
      ...
      return localVarFp
        .getEventTypeById(eventTypeID, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getEventTypes(
      ...
      return localVarFp
        .getEventTypes(limit, page, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class EventTypesApi extends BaseAPI {
  ...
  public createEventType(
    ...
    return EventTypesApiFp(this.configuration)
      .createEventType(createEventTypeRequest, options)
      .then((request) => request(this.axios, this.basePath));
  }
...
export const MessagesApiAxiosParamCreator = function (
  ...
  return {
    ...
    sendMessage: async (
      ...
      const localVarPath = `/applications/{applicationID}/messages`.replace(
        `{${"applicationID"}}`,
        encodeURIComponent(String(applicationID))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const MessagesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["MessagesApi.sendMessage"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const MessagesApiFactory = function (
  ...
  return {
    ...
    sendMessage(
      ...
      return localVarFp
        .sendMessage(applicationID, sendMessageRequest, options)
        .then((request) => request(axios, basePath));
    },
  };
};
