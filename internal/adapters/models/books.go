...
type Book struct {
	...
	PublicationDate time.Time   `boil:"publication_date" json:"publication_date" toml:"publication_date" yaml:"publication_date"`
	Authors         string      `boil:"authors" json:"authors" toml:"authors" yaml:"authors"`
	Isbn            int         `boil:"isbn" json:"isbn" toml:"isbn" yaml:"isbn"`
...
var BookWhere = struct {
	...
	PublicationDate whereHelpertime_Time
	...
	Subtitle:        whereHelpernull_String{field: "\"books\".\"subtitle\""},
	Publisher:       whereHelperstring{field: "\"books\".\"publisher\""},
	PublicationDate: whereHelpertime_Time{field: "\"books\".\"publication_date\""},
	Authors:         whereHelperstring{field: "\"books\".\"authors\""},
	Isbn:            whereHelperint{field: "\"books\".\"isbn\""},
	Format:          whereHelperstring{field: "\"books\".\"format\""},
}
...
type bookR struct {
	BookCopies BookCopySlice `boil:"BookCopies" json:"BookCopies" toml:"BookCopies" yaml:"BookCopies"`
}
...
func (r *bookR) GetBookCopies() BookCopySlice {
	if r == nil {
		return nil
	}
	return r.BookCopies
...
var (
	bookAllColumns            = []string{"id", "title", "subtitle", "publisher", "publication_date", "authors", "isbn", "format"}
	bookColumnsWithoutDefault = []string{"id", "title", "publisher", "publication_date", "authors", "isbn"}
	bookColumnsWithDefault    = []string{"subtitle", "format"}
...
// BookCopies retrieves all the book_copy's BookCopies with an executor.
func (o *Book) BookCopies(mods ...qm.QueryMod) bookCopyQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"book_copies\".\"book_id\"=?", o.ID),
	)

	return BookCopies(queryMods...)
}

// LoadBookCopies allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (bookL) LoadBookCopies(ctx context.Context, e boil.ContextExecutor, singular bool, maybeBook interface{}, mods queries.Applicator) error {
	var slice []*Book
	var object *Book
	...
	query := NewQuery(
		qm.From(`book_copies`),
		qm.WhereIn(`book_copies.book_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load book_copies")
	}

	var resultSlice []*BookCopy
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice book_copies")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results in eager load on book_copies")
	}
	...
	if singular {
		object.R.BookCopies = resultSlice
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if local.ID == foreign.BookID {
				local.R.BookCopies = append(local.R.BookCopies, foreign)
				if foreign.R == nil {
					foreign.R = &bookCopyR{}
				}
...
// AddBookCopies adds the given related objects to the existing relationships
// of the book, optionally inserting them as new records.
// Appends related to o.R.BookCopies.
// Sets related.R.Book appropriately.
func (o *Book) AddBookCopies(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*BookCopy) error {
	var err error
	...
	if o.R == nil {
		...
		o.R.BookCopies = append(o.R.BookCopies, related...)
	}
