...
func (x *SomethingHappened) GetHeader() *Header {
	if x != nil {
		return x.Header
	}
	return nil
...
func (x *SomethingHappened) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_events_proto_rawDesc = []byte{
	...
	0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x65, 0x64, 0x41, 0x74, 0x22, 0x44, 0x0a, 0x11, 0x53,
	...
	0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x64, 0x64, 0x6f, 0x74, 0x64, 0x65, 0x76,
	0x2f, 0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x64, 0x2d, 0x62, 0x61, 0x63, 0x6b,
	0x65, 0x6e, 0x64, 0x2f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_events_proto_goTypes = []interface{}{
	(*Header)(nil),                // 0: Header
	(*SomethingHappened)(nil),     // 1: SomethingHappened
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_events_proto_depIdxs = []int32{
	2, // 0: Header.published_at:type_name -> google.protobuf.Timestamp
	0, // 1: SomethingHappened.header:type_name -> Header
